...
function createBaseOnesieHeader_UnknownMessage1() {
    return { videoId: "" };
}
export const OnesieHeader_UnknownMessage1 = {
    encode(message, writer = new BinaryWriter()) {
        if (message.videoId !== undefined && message.videoId !== "") {
            writer.uint32(18).string(message.videoId);
        }
...
function createBaseOnesieHeader_UnknownMessage2() {
    return { itagDenylist: [] };
}
export const OnesieHeader_UnknownMessage2 = {
    encode(message, writer = new BinaryWriter()) {
...
//# sourceMappingURL=onesie_header.js.map