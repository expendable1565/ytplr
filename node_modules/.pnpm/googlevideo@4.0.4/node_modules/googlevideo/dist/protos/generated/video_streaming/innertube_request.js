...
function createBaseInnertubeRequest() {
    return {
...
export const InnertubeRequest = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.unencryptedOnesieInnertubeRequest !== undefined && message.unencryptedOnesieInnertubeRequest.length !== 0) {
...
function createBaseUstreamerFlags() {
    return { sendVideoPlaybackConfig: false };
}
export const UstreamerFlags = {
    encode(message, writer = new BinaryWriter()) {
...
//# sourceMappingURL=innertube_request.js.map