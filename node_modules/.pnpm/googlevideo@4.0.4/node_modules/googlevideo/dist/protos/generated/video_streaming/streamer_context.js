...
export const StreamerContext_ClientFormFactor = {
    UNKNOWN_FORM_FACTOR: 0, 0: "UNKNOWN_FORM_FACTOR",
...
export const StreamerContext_SabrContext = {
    encode(message, writer = new BinaryWriter()) {
...
export const StreamerContext_UnknownMessage1 = {
    encode(message, writer = new BinaryWriter()) {
...
export const StreamerContext_UnknownMessage1_UnknownInnerMessage1 = {
    encode(message, writer = new BinaryWriter()) {
...
//# sourceMappingURL=streamer_context.js.map