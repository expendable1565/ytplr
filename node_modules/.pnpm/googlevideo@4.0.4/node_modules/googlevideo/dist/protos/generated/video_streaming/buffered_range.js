...
export const BufferedRange_UnknownMessage1 = {
    encode(message, writer = new BinaryWriter()) {
...
export const BufferedRange_UnknownMessage1_UnknownInnerMessage = {
    encode(message, writer = new BinaryWriter()) {
...
export const BufferedRange_UnknownMessage2 = {
    encode(message, writer = new BinaryWriter()) {
...
//# sourceMappingURL=buffered_range.js.map